...
public abstract class AbstractParticleEmitterEditScreen extends Screen {
	...
	public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTicks) {
		...
		graphics.text(this.font, PARTICLE_LABEL, this.width / 2 - 151, 40, ARGB.opaque(16777215));
		graphics.text(this.font, SPECIAL_LABEL, this.width / 2 + 1, 40, ARGB.opaque(16777215));

		graphics.text(this.font, OFFSET_LABEL, this.width / 2 - 150, 74, ARGB.opaque(16777215));
		graphics.text(this.font, DELTA_LABEL, this.width / 2 - 75, 74, ARGB.opaque(16777215));

		graphics.text(this.font, SPEED_LABEL, this.width / 2 + 1, 74, ARGB.opaque(16777215));
		graphics.text(this.font, COUNT_LABEL, this.width / 2 + 52, 74, ARGB.opaque(16777215));
		graphics.text(this.font, INTERVAL_LABEL, this.width / 2 + 103, 74, ARGB.opaque(16777215));
